...
While running the model use this weights. These weights are generated by training the model with spectific requirement of extracting the license plate. Training is done by using the existing yolo model.
